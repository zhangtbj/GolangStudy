...
func getResourceUsageAccount(creds core.BearerTokenAuthenticator) (bool, error) {
	...
	resourceUsageOption := usageReport.NewGetResourceUsageAccountOptions("27212a64558a41a9b19577d4232fc3f2", "2021-07")
	...
	accountSummaryOptions := usageReport.NewGetAccountSummaryOptions("27212a64558a41a9b19577d4232fc3f2", "2021-07")
